options = 
{
	...
	{ 
		default = 2, 
		label = "Survival: Enemy Soft Unit Cap", 
		help = "If a soft cap is set, wave spawning is paused while the enemy has more than the max number of units. Waves will resume spawning once enemy numbers are reduced.", 
		...
		values = {
			...
			{text = "100",	help = "100 units", key = 100, },
